...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "78", subUrl: "/FloorPlan/59B" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#2b3b48" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#2b3b48" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#2b3b48" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup

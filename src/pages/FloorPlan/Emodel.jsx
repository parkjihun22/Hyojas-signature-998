...
<Helmet>
  {/* 핵심 SEO 페이지: E-모델하우스 */}
  <title>효자 시그니처 998 - E-모델하우스</title>
  <meta
    name="description"
  ...
  <meta property="og:title" content="효자 시그니처 998 - E-모델하우스" />
  <meta
  ...
  <meta name="twitter:title" content="효자 시그니처 998 - E-모델하우스" />
  <meta
...
<p className={styles.screenReaderOnly}>
  효자 시그니처 998 E-모델하우스를 통해 세대별 구조와 공간 구성을 확인할 수 있습니다.
  다양한 평면 정보를 통해 단지의 주거 환경을 미리 경험해보세요.
</p>

<div className={styles.textBox}>
  <div>현장을 가지 않아도</div>
  <div>효자 시그니처 998를 온라인에서 확인하세요.</div>
</div>
      ...
      <h1 className={styles.screenReaderOnly}>효자 시그니처 998- E-모델하우스</h1>

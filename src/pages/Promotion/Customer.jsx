...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/mvzvjagy", {
        method: "POST",
...
<Helmet>
  {/* 페이지별 메타 */}
  <title>효자 시그니처 998 - 관심고객등록</title>
  <meta
    name="description"
    content="효자 시그니처 998 관심고객 등록을 통해 분양 정보와 주요 안내를 가장 먼저 받아보세요."
  />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://delidilly.co.kr/Promotion/Customer" />

  {/* Open Graph */}
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="효자 시그니처 998" />
  <meta property="og:title" content="효자 시그니처 998 - 관심고객등록" />
  <meta
    property="og:description"
    content="효자 시그니처 998 관심고객 등록을 통해 다양한 분양 정보를 가장 먼저 받아보세요."
  />
  <meta property="og:url" content="https://delidilly.co.kr/Promotion/Customer" />
  <meta property="og:image" content="https://delidilly.co.kr/img/og/customer.jpg" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />

  {/* Twitter */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="효자 시그니처 998 - 관심고객등록" />
  <meta
    name="twitter:description"
    content="효자 시그니처 998 관심고객 등록을 통해 주요 안내와 분양 정보를 확인하세요."
  />
  <meta name="twitter:image" content="https://delidilly.co.kr/img/og/customer.jpg" />
  <meta name="twitter:url" content="https://delidilly.co.kr/Promotion/Customer" />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "url": "https://delidilly.co.kr/Promotion/Customer",
      "description":
        "효자 시그니처 998 관심고객 등록을 통해 다양한 분양 정보를 안내받을 수 있습니다.",
      "primaryImageOfPage": {
        "@type": "ImageObject",
        "contentUrl": "https://delidilly.co.kr/img/og/customer.jpg",
        "width": 1200,
        "height": 630
      },
      "breadcrumb": {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "관심고객등록", "item": "https://delidilly.co.kr/Promotion/Customer" }
        ]
      }
    })}
  </script>
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>효자 시그니처 998</h2>

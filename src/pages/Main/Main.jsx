...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `도심 중심 주거 가치`,
    text2: `전주 효자동 중심 생활권 입지<br/>
            편리한 생활 인프라를 갖춘 주거 환경`,
        ...
        <>
          ...
          {!isOpenPopup2 && isOpenPopup3 && (
            ...
            <div className={styles.imageContainer}>
              <img
                ...
                alt="효자 시그니처 998-mainimage1"
              />
              <div className={styles.overlay}></div>
              <div className={styles.mainImageTextBox}>
                <div className={styles.mainImageTextSub}>
                  전주 효자동 중심 <span className={styles.greyText}>프리미엄 주거</span>
                </div>
                <div className={styles.mainImageTitleBox}>
                  <div className={styles.mainImageText}>전주가 기다린 새로운 주거 가치</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 전주 효자동 중심 생활권으로 편리한 도심 인프라<br />
                  - 교육·상업·생활시설이 가까운 완성된 주거 환경<br />
                  - 전주 주요 도심과 연결되는 편리한 교통 접근성<br />
                  - 쾌적한 주거 환경과 여유로운 생활을 누리는 도심 주거 단지
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="효자 시그니처 998브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>효자 시그니처 998</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mvzvjagy"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="효자 시그니처 998오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="효자 시그니처 998 모바일 메인 이미지 1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
              <div className={styles.mainImageTextSub1}>
                전주 효자동 중심에서 시작되는 새로운 주거 가치<br/>
                도심 라이프의 프리미엄
                <br />
                <span className={styles.greyText1}>효자 시그니처 998</span>
                <br />
              </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 효자 시그니처 998에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="효자 시그니처 998모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="효자 시그니처 998브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="효자 시그니처 998오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
